...
instruction="Use your tools to review the provided trip ideas. Respond ONLY with the ideas likely under the provided budget for a weekend. If none seem to fit, s",
tools=[google_search],
disallow_transfer_to_peers=True,
)
...
# https://github.com/google/adk-docs/tree/main/examples/python/agent-samples/youtube-shorts-assistant
